...
?>
                    <div id="contenidoTxt">
                            <!-- <h2 class="textogriscorp"><?php echo T_BODEGA_H1; ?></h2> -->
                        <div id="imgvinedobodega">
                            <img id="imgvinedobodega" src="<?php echo $urlpath ?>images/pequenas_400px/_MG_4456.jpg" alt="<?php echo T_BODEGA_H1; ?>" />
                        </div>
                        <div id="txtalladoimgvinedobodega">
                            <div id="h1vinedobodega" class="h1pages"><?php echo T_BODEGA_H1; ?></div>
                <?php echo "<span id=\"txtalladoimgvinedobodega\">" . T_BODEGA_PARR1 . "<br /><br />" . T_BODEGA_PARR2 . "</span>"; ?>
                        </div>
                        <br class="clear" />
                        <div id="txtabajovinedobodega"">
<?php echo T_BODEGA_PARR3; ?>
                        </div>
                    </div>
                </div>
