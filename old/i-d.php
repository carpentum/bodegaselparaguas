...
?>
                    <div id="contenidoTxt">
                            <!-- <h2 class="textogriscorp"><?php echo T_ID_H1; ?></h2> -->
                        <div id="imgvinedobodega">
                            <img id="imgid" class="img-shadow" src="<?php echo $urlpath ?>images/pequenas_400px/foto_I+D_400x225.jpg" alt="<?php echo T_ID_H1; ?>" />
                        </div>
                        <div id="txtalladoimgvinedobodega">
                            <div id="h1vinedobodega" class="h1pages"><?php echo T_ID_H1; ?></div>
                <?php echo "<span id=\"txtalladoimgvinedobodega\">" . T_ID_PARR1 . "<br /><br />" . T_ID_PARR2 . "</span>"; ?>
                        </div>
                        <br class="clear" />
