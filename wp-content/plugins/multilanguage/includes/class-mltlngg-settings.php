				...
				<tr>
					...
					<td>
						<fieldset>
							...
							<br/>
							<label>
								<input name="mltlngg_language_switcher" type="radio" value="first-letters" <?php checked( $this->options['language_switcher'], 'first-letters' ); ?> />
								<?php _e( 'Letras', 'multilanguage' ); ?>
							</label>
						</fieldset>
					</td>
				</tr>
